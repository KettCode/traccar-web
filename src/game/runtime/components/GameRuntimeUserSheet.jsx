...
const GameRuntimeUserSheet = ({ open, currentGame, user, socket, onClose, onLogout, t }) => {
  ...
  const clientSetupItem = currentGame?.clientSetupLink
    ? { clientSetupLink: currentGame.clientSetupLink }
    : null;
  ...
  return (
    <>
      ...
      >
        <DialogTitle sx={{ pb: 1 }}>
          <Stack direction="row" spacing={1.5} alignItems="center">
            <Avatar
              sx={{ bgcolor: roleAvatarColor(currentGame?.memberRole), width: 52, height: 52 }}
            >
      ...
      <GameClientSetupDialog
        item={clientSetupOpen ? clientSetupItem : null}
